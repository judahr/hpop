...
namespace OpenPop.TestApplication
{
	...
	public class TestForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridHeaders.RowHeadersDefaultCellStyle.ForeColor = System.Drawing.SystemColors.ControlText;
			...
			// contextMenuMessages
			// 
			this.contextMenuMessages.Items.AddRange(new System.Windows.Forms.ToolStripMenuItem[] {
            this.menuDeleteMessage,
            this.menuViewSource});
			// 
			// menuDeleteMessage
			// 
			//this.menuDeleteMessage. = 0;
